                    ...
                    <div class="" role="tabpanel" data-example-id="togglable-tabs">
                        ...
                        <div id="myTabContent" class="tab-content">
                            ...
                            <div role="tabpanel" class="tab-pane fade active in" id="tab_content1" aria-labelledby="home-tab">
                                ...
                                <form method="post" action="<?php echo site_url('super_admin/notification/tips_trick_ubah/'.$id); ?>" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                                    <input type="hidden" name="id" value="<?=$id;?>" />
                                    <div class="form-group">
                                        <label for="title" class="control-label col-md-3 col-sm-3 col-xs-12">Title <span class="required">*</span></label>
                                        <div class="col-md-3 col-sm-12">
                                            <input type="text" name="title" id="title" required="required" class="form-control col-md-7 col-xs-12" value="<?=$tips_trick['title'];?>" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="detail" class="control-label col-md-3 col-sm-3 col-xs-12">Detail <span class="required">*</span></label>
                                        <div class="col-md-4 col-sm-12">
                                            <textarea name="detail" id="detail" required="required" class="form-control col-md-7 col-xs-12" cols="8" rows="5"><?=$tips_trick['detail'];?></textarea>
                                        </div>
                                    </div>
